...
const News = () => {
  const news = [
...

    {
      ...
      caption:
        "Na lokacijama Staroga grada i sinjskog varoša, pod okriljem kolovoške noći, već nekoliko godina uprizoruju se događaji koji su prethodili slavnoj pobjedi nad Osmanlijama 15. kolovoza 1715. godine.",
      time: "03.06.2023.",
      time: "15.08.2023.",
    },
      ...
      >
        {news.map((news) => (
          <div className="my-5 cursor-pointer border hover:scale-105 ease-in-out duration-500">
            ...
            <div className="text-s w-[300px] h-[200px] px-2">
              {news.caption}
            </div>
          </div>
        ))}
